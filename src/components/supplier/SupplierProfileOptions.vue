    ...
    <b-card no-body>
          <b-card class="text-left">
            ...
            <b-collapse id="collapse-2" visible>
              ...
              <p><strong>Company: </strong>{{this.supplier.company}}</p>
            </b-collapse>
          ...
          <b-card class="text-left">
            <b-card-title> <h3>Account Info </h3></b-card-title>
            <p><strong>Username: </strong>{{ this.supplier.username }}</p>
            <p><strong>Email: </strong>{{ this.supplier.email }}</p>
          </b-card>
...
export default {
    ...
    mounted(){
        this.num += 1;
        supplierService.getDetails(this.loggedUser().id)
            .then(response=>{
                ...
                this.defaultSupplierData = {...response.data};
    ...
    methods: {
        ...
        updateProfileInfo(){
            ...
            supplierService.updateProfileInfo(this.loggedUser().id, this.payload)
                .then(response=>{
                    this.supplier = {...response.data};
                    this.defaultSupplierData = {...response.data};
                    this.payload = {
        ...
        resetProfileInfo(){
            this.payload.firstName = this.defaultSupplierData.firstName;
            this.payload.lastName = this.defaultSupplierData.lastName;
            this.payload.company = this.defaultSupplierData.company;
            this.$refs.btnEditPersonalInfo.click();
        },
