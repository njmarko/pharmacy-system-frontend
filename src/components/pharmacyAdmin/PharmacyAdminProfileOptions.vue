    ...
    <b-card no-body>
      <b-card class="text-left">
        ...
        <b-collapse id="collapse-2" visible>
          <p>
            <strong>Full name: </strong>{{ this.admin.firstName }}
            {{ this.admin.lastName }}
          </p>
        </b-collapse>
...
export default {
  data() {
    return {
      ...
      defaultPharmacyAdminData: {},
    };
  },
  mounted() {
      this.admin = {...this.loggedUser};
      this.defaultPharmacyAdminData = {...this.loggedUser};
      this.payload = {...this.admin};
      this.loaded = true;
  },
  methods: {
    ...
    updateProfileInfo() {
      pharmacyAdminService
        ...
        .then((response) => {
          ...
          this.defaultPharmacyAdminData = { ...response.data };
          this.payload = {
    ...
    resetProfileInfo() {
      this.payload.firstName = this.defaultPharmacyAdminData.firstName;
      this.payload.lastName = this.defaultPharmacyAdminData.lastName;
      this.$refs.btnEditPersonalInfo.click();
    },
