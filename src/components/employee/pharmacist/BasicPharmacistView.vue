...
export default {
  ...
  methods: {
    ...
    getPharmacistsImage: function (pharmacist) {
      return `https://via.placeholder.com/600x300/b3dce8/002664?text=${pharmacist.firstName} ${pharmacist.lastName}`;
    },
