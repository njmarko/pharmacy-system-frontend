        ...
        <b-form-group id="input-group-32" class="mb-auto">
          <div class="form-label-group">
            <multi-select
              ...
              placeholder="Please select appointment type(s)"
  ...
  data() {
    return {
      ...
      typeOptions: [
        ...
        { value: "DERMATOLOGIST", text: "Dermatologist appointments" },
        { value: "PHARMACIST", text: "Pharmacist appointments" },
      ],
    };
  },
  mounted() {
